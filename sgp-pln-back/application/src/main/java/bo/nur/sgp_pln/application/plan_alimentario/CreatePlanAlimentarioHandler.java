...
@RequestScoped
public class CreatePlanAlimentarioHandler implements IRequestHandler<CreatePlanAlimentarioCommand, Result<UUID>> {

    private IPlanAlimentarioRepository repository;

    @Inject
    public CreatePlanAlimentarioHandler(IPlanAlimentarioRepository repository) {
