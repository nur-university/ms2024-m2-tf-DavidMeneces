...
@RequestScoped
public class GetPlanAlimentarioHandler implements IRequestHandler<CreatePlanAlimentarioCommand, Result<UUID>> {

    private IPlanAlimentarioRepository repository;

    @Inject
    public GetPlanAlimentarioHandler(IPlanAlimentarioRepository repository) {
